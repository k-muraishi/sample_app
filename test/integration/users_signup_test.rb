...
class UsersSignupTest < UsersSignup
  ...
  # end
  #   Failure:
  # 　UsersSignupTest#test_invalid_signup_information [/Users/k.muraishi/ProjectFiles/Rails_tutorial/environment/sample_app/test/integration/users_signup_test.rb:19]:
  # 　Expected response to be a <422: unprocessable_entity>, but was a <200: OK>.
  # 　Expected: 422
  #   Actual: 200　になるためコメントか
